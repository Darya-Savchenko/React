        ...
        <div className="mt-10 justify-between gap-8 md:flex">
          ...
          >
            <form
              ...
              onSubmit={onSubmit}
              method="POST"
              action="https://formsubmit.co/savchenkodarya277@gmail.com"
            >
              <input
              ...
              />
              {errors.name && (
                <p className="nt-1 text-primary-500">
              ...
              <button
                type="submit"
                className="rounded-md bg-secondary-500 px-10 py-2 mt-5 hover:bg-primary-500 transition duration-500 hover:text-white"
              >
                SUBMIT
              </button>
            </form>
